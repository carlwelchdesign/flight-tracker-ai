        ...
        <div className="alert-workspace">
          ...
          <div className="alert-inspector" aria-live="polite">
            ...
            {selectedDetail && <>
              ...
              <label className="alert-note-field"><span>Dispatcher note</span><textarea value={message} onChange={(event) => setMessage(event.target.value)} rows={2} disabled={Boolean(actionPending) || !canManage} placeholder="Add context for the audit trail" /></label>
