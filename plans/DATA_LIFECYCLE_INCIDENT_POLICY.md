...
| Alerts, dispatcher actions, and rule evidence | 12 months for pilot evaluation, subject to provider derivative rights | Preserve append-only decision evidence; redact/delete prohibited source fields; Legal approves any litigation/security hold. | Two-person whole-terminal-series deletion, logical replay suppression, and separately approved scheduling implemented; hosted execution remains pending. |
