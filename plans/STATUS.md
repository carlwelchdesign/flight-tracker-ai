...
- Next action: Enroll the reviewer in the production Clerk organization, record
  the Neon snapshot/isolated-restore drill, and run the authenticated browser
  and hosted FT-401 smoke before final promotion.
