...
- FT-404 is active in draft PR [#24](https://github.com/carlwelchdesign/flight-tracker-ai/pull/24) at implementation commit `03cbd31`. Vercel project `flight-tracker-ai` is connected to this repository with `apps/web` as the Next.js root; its first candidate artifact built successfully and remains behind Vercel deployment protection while Render, Neon, Clerk, and hosted smoke gates are configured.
