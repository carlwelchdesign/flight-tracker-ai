...
- Next action: Resolve the remaining dependency-safe FT-401 findings, beginning with credential rotation and browser security headers; leave commercial-provider controls blocked until FT-301 resolves.
