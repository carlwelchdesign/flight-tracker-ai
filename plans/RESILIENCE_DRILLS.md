...
| Bounded alert backlog | Queue 183 batches before the restarted worker begins | A final marker alert proves FIFO drain; elapsed time is printed as `FT402_BACKLOG` | Work below the production 256-batch channel bound drains without duplication or lifecycle loss |
